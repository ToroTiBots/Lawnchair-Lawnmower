# Lawnchair 15 - Go to bottom to learn about Lawnmower
...
Lawnmower is a fork of lawnchair to make it feel more mainstream and more unique among other launchers.

Lawnmower is currently on development and is more useful for lower end devices.

I suggest trying out lawnchair 2 for old low end devices and Lawnmower for newer devices.

## Lawnmower Download

Lawnmower does NOT have a official download yet and is not suggested to download using the github files till the complete version comes out.
